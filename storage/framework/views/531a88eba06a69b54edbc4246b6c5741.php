    ...
    <div class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8 md:p-12 mb-10 prose max-w-none">
            ...
            <p class="text-gray-500 text-sm italic text-center mt-10">
                Última atualização: <?php echo e($page->updated_at->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\portal-estagiario\resources\views/public/termos-de-uso.blade.php ENDPATH**/ ?>