            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div x-data="profileFormComponent(
                        <?php echo \Illuminate\Support\Js::from($initialData)->toHtml() ?>,
                        <?php echo \Illuminate\Support\Js::from($estados)->toHtml() ?>,
                        <?php echo \Illuminate\Support\Js::from($cidades)->toHtml() ?>,
                        <?php echo \Illuminate\Support\Js::from($instituicoes)->toHtml() ?>,
                        <?php echo \Illuminate\Support\Js::from($cursos)->toHtml() ?>,
                        <?php echo e($totalProfileFieldsCount); ?>,
                        <?php echo \Illuminate\Support\Js::from(\App\Models\Candidato::getCompletableFields())->toHtml() ?>,
                        <?php echo \Illuminate\Support\Js::from($candidato->status)->toHtml() ?> 
                    )" x-init="init()">
                        ...
                        <form method="POST" action="<?php echo e(route('candidato.profile.update')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div x-show="step === 1" x-transition>
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="col-span-12">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('nome_completo', 1) }" x-model="fields.nome_completo" id="nome_completo" name="nome_completo" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12">
                                        <label for="nome_mae" class="block font-medium text-sm text-gray-700">Nome da Mãe <span class="text-red-500">*</span></label>
                                        <input :class="{ 'border-red-500': isInvalid('nome_mae', 1) }" x-model="fields.nome_mae" id="nome_mae" name="nome_mae" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12">
                                        <label for="nome_pai" class="block font-medium text-sm text-gray-700">Nome do Pai</label>
                                        <input x-model="fields.nome_pai" id="nome_pai" name="nome_pai" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('data_nascimento', 1) }" x-model="fields.data_nascimento" id="data_nascimento" name="data_nascimento" type="date" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="sexo" class="block font-medium text-sm text-gray-700">Sexo <span class="text-red-500">*</span></label>
                                        <select :class="{ 'border-red-500': isInvalid('sexo', 1) }" x-model="fields.sexo" id="sexo" name="sexo" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input x-model="fields.rg" id="rg" name="rg" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="rg_orgao_expedidor" class="block font-medium text-sm text-gray-700">Órgão Expedidor</label>
                                        <input x-model="fields.rg_orgao_expedidor" id="rg_orgao_expedidor" name="rg_orgao_expedidor" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('possui_deficiencia', 1) }" x-model="fields.possui_deficiencia" id="possui_deficiencia" name="possui_deficiencia" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                            <option value="">Selecione...</option>
                                    ...
                                    <div class="col-span-12 sm:col-span-4">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('naturalidade_estado', 1) }" x-model="fields.naturalidade_estado" name="naturalidade_estado" id="naturalidade_estado" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                            <option value="">Selecione</option>
                                            <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($estado->id); ?>"><?php echo e($estado->uf); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-8">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('naturalidade_cidade', 1) }" x-model="fields.naturalidade_cidade" name="naturalidade_cidade" id="naturalidade_cidade" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                            ...
                            <div x-show="step === 2" x-transition>
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('telefone', 2) }" x-mask="(99) 99999-9999" x-model="fields.telefone" id="telefone" name="telefone" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="cep" class="block font-medium text-sm text-gray-700">CEP <span class="text-red-500">*</span></label>
                                        <input :class="{ 'border-red-500': isInvalid('cep', 2) }" x-mask="99999-999" x-model="fields.cep" id="cep" name="cep" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-9">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('logradouro', 2) }" x-model="fields.logradouro" id="logradouro" name="logradouro" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12 sm:col-span-3">
                                        <label for="numero" class="block font-medium text-sm text-gray-700">Número <span class="text-red-500">*</span></label>
                                        <input :class="{ 'border-red-500': isInvalid('numero', 2) }" x-model="fields.numero" id="numero" name="numero" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12">
                                        <label for="bairro" class="block font-medium text-sm text-gray-700">Bairro <span class="text-red-500">*</span></label>
                                        <input :class="{ 'border-red-500': isInvalid('bairro', 2) }" x-model="fields.bairro" id="bairro" name="bairro" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    
                                    <div class="col-span-12 sm:col-span-4">
                                        <label for="estado" class="block font-medium text-sm text-gray-700">Estado <span class="text-red-500">*</span></label>
                                        <select :class="{ 'border-red-500': isInvalid('estado', 2) }" x-model="fields.estado" name="estado" id="estado" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                            <option value="">Selecione</option>
                                            <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($estado->id); ?>"><?php echo e($estado->uf); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-span-12 sm:col-span-8">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('cidade', 2) }" x-model="fields.cidade" name="cidade" id="cidade" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                            <option value="">Selecione a Cidade</option>
                            ...
                            <div x-show="step === 3" x-transition>
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="col-span-12">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('instituicao_id', 3) }" x-model="fields.instituicao_id" name="instituicao_id" id="instituicao_id" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                            <option value="">Selecione...</option>
                                            <?php $__currentLoopData = $instituicoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instituicao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($instituicao->id); ?>"><?php echo e($instituicao->nome); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <select :class="{ 'border-red-500': isInvalid('curso_id', 3) }" x-model="fields.curso_id" name="curso_id" id="curso_id" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('curso_data_inicio', 3) }" x-model="fields.curso_data_inicio" id="curso_data_inicio" name="curso_data_inicio" type="date" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('curso_previsao_conclusao', 3) }" x-model="fields.curso_previsao_conclusao" name="curso_previsao_conclusao" type="date" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('semestres_completos', 3) }" x-model="fields.semestres_completos" name="semestres_completos" type="number" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input :class="{ 'border-red-500': isInvalid('media_aproveitamento', 3) }" x-model="fields.media_aproveitamento" name="media_aproveitamento" type="text" class="mt-1 block w-full rounded-md shadow-sm border-gray-300" required :disabled="isAguardandoHomologacao"> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between mt-6 pt-6 border-t">
                                ...
                                <button type="button" x-show="step === 1" @click.prevent="attemptNextStep(1)" :disabled="isAguardandoHomologacao" class="px-4 py-2 text-white rounded-lg bg-blue-600 hover:bg-blue-700">Próximo</button> 
                                <button type="button" x-show="step === 2" @click.prevent="attemptNextStep(2)" :disabled="isAguardandoHomologacao" class="px-4 py-2 text-white rounded-lg bg-blue-600 hover:bg-blue-700">Próximo</button> 
                                
                                <button type="submit" x-show="step === 3" :disabled="isAguardandoHomologacao" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Salvar Perfil</button> 
                            </div>
                        </form>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\portal-estagiario\resources\views/candidato/profile/edit.blade.php ENDPATH**/ ?>