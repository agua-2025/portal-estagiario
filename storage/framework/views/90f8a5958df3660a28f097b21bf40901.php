    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                <?php echo e(__('Altere as informações do usuário conforme necessário')); ?>
                ...
                <div class="p-8">
                    <form method="POST" action="<?php echo e(route('admin.users.update', $user)); ?>" class="space-y-8" id="userEditForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="max-w-md">
                                <input 
                                    ...
                                    type="text" 
                                    name="cpf" 
                                    value="<?php echo e(old('cpf', $user->candidato->cpf ?? '')); ?>" 
                            ...
                            <p class="text-xs text-gray-500">
                                <?php echo e(__('O CPF é obrigatório caso o usuário seja ou se torne um Estagiário')); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="password" class="block text-sm font-medium text-gray-700">
                                    <?php echo e(__('Nova Senha')); ?>

                                    <span class="text-xs text-gray-500 font-normal ml-1">(<?php echo e(__('deixe em branco para não alterar')); ?>)</span>
                                </label>
                                <div class="relative">
                                    <input 
                                        id="password" 
...
<?php endif; ?>
                            ...
                            <div class="space-y-2">
                                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">
                                    <?php echo e(__('Confirmar Nova Senha')); ?>
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleName => $roleLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                                        <input 
                                            type="checkbox" 
                                            name="roles[]" 
                                            id="role_<?php echo e($roleName); ?>" 
                                            value="<?php echo e($roleName); ?>"
                                            class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2"
                                            <?php echo e(in_array($roleName, old('roles', $userRoles)) ? 'checked' : ''); ?>

                                        >
                                        <label for="role_<?php echo e($roleName); ?>" class="text-sm font-medium text-gray-700 capitalize cursor-pointer">
                                            <?php echo e($roleLabel); ?>

                                        </label>
                                        <?php if($roleName === 'estagiario'): ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" class="px-6 py-2 bg-indigo-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200 flex items-center space-x-2">
                                ...
                                <span><?php echo e(__('Atualizar Usuário')); ?></span>
                            </button>
                        </div>
                    </form>
                </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\portal-estagiario\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>