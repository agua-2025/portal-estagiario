    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-800">Cadastrar Novo Curso</h1>
        ...
        <form action="<?php echo e(route('admin.cursos.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                          ...
                          maxlength="500"><?php echo e(old('descricao')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Descrição detalhada do curso, objetivos, metodologia, etc."><?php echo e(old('detalhes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Cole o código SVG completo aqui (ex: <svg ...>...</svg>)"><?php echo e(old('icone_svg')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('valor_bolsa_auxilio')); ?>"
                               placeholder="0,00">
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('valor_auxilio_transporte')); ?>"
                               placeholder="0,00">
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Escolaridade, idade, experiência, etc."><?php echo e(old('requisitos')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Certificado, material didático, alimentação, etc."><?php echo e(old('beneficios')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('carga_horaria')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('local_estagio')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\portal-estagiario\resources\views/admin/cursos/create.blade.php ENDPATH**/ ?>