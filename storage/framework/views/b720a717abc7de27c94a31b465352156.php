                                ...
                                <div class="flex-1">
                                    ...
                                    <ul class="text-base text-red-600 space-y-1 list-disc list-inside mb-3">
                                        <?php if($documentosRejeitados->count() > 0): ?>
                                            <li><strong><?php echo e($documentosRejeitados->count()); ?> documento(s) rejeitado(s)</strong> - precisam ser reenviados</li>
                                        <?php endif; ?>
                                        <?php if($atividadesRejeitadas->count() > 0): ?>
                                            <li><strong><?php echo e($atividadesRejeitadas->count()); ?> atividade(s) rejeitada(s)</strong> - verifique se ainda há prazo para recurso</li>
                                        <?php endif; ?>
                                    </ul>
                                    
                                    <div class="flex space-x-3 text-base">
                                        <?php if($documentosRejeitados->count() > 0): ?>
                                            <a href="<?php echo e(route('candidato.documentos.index')); ?>" class="text-red-600 hover:text-red-800 underline font-medium">
                                                Corrigir documentos
                                            </a>
                                        <?php endif; ?>
                                        <?php if($atividadesRejeitadas->count() > 0): ?>
                                            <a href="<?php echo e(route('candidato.atividades.index')); ?>" class="text-red-600 hover:text-red-800 underline font-medium">
            ...
            <div class="ml-3 flex-grow">
                <p class="text-base text-purple-800">
                    ...
                    <?php if(auth()->user()->candidato->ato_homologacao): ?>
                        <span class="block mt-1 text-sm text-purple-700">Ato de Homologação: <?php echo e(auth()->user()->candidato->ato_homologacao); ?></span>
                    <?php endif; ?>
                </p>
                ...
                <?php if(Auth::user()->candidato?->pode_interpor_recurso): ?>
                    <div class="mt-3 pt-3 border-t border-purple-200">
                        <p class="text-sm text-purple-700">
                            ...
                            <strong class="text-purple-800"><?php echo e($dataFinal->format('d/m/Y \à\s H:i')); ?></strong>.
                        </p>
                    </div>
                <?php endif; ?>
            </div>
