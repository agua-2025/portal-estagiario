<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('Apagar Conta')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Uma vez que sua conta for apagada, todos os seus recursos e dados serão permanentemente excluídos. Por favor, digite sua senha para confirmar que deseja apagar sua conta permanentemente.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">
                <?php echo e(__('Tem certeza de que deseja apagar sua conta?')); ?>
            ...
            <?php if($errors->userDeletion->has('general_error')): ?>
                <div class="mt-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded-md">
                    <?php echo e($errors->userDeletion->first('general_error')); ?>
...
<?php endif; ?>
</section><?php /**PATH C:\laragon\www\portal-estagiario\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>