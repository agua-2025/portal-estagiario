                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $documentosNecessarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo => $nome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="py-4 border-b last:border-b-0">
                                ...
                                <div class="mt-3">
                                    <?php if(!$documentoEnviado || $documentoEnviado->status === 'rejeitado'): ?>
                                        <form action="<?php echo e(route('candidato.documentos.store')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-wrap items-center gap-3">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <button type="submit" class="px-4 py-1.5 border border-blue-600 text-blue-700 rounded-md text-sm font-semibold hover:bg-blue-600 hover:text-white ml-auto transition-colors duration-200 flex-shrink-0">
                                                <?php echo e($documentoEnviado?->status === 'rejeitado' ? 'Enviar Correção' : 'Enviar'); ?>
