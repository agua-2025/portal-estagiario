            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between py-3 sm:py-4 w-full">
                    <div class="flex items-center space-x-2 sm:space-x-3 overflow-visible" data-aos="fade-right">
                        <a href="<?php echo e(route('welcome')); ?>" class="flex items-center space-x-2 sm:space-x-3 overflow-visible">
                    ...
                    <div class="hidden sm:flex items-center space-x-2 flex-shrink-0" data-aos="fade-left">
                        <?php if(Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="px-4 lg:px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">Painel</a>
                            <?php else: ?>
                                ...
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="px-3 lg:px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl lg:px-6">
                                        Inscreva-se
                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
