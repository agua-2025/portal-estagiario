                                        ...
                                        <form action="<?php echo e(route('admin.candidatos.homologar', $candidato->id)); ?>" method="POST" class="w-full">
                                            ...
                                            <div class="bg-yellow-50 p-3 rounded">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <textarea name="homologacao_observacoes" id="homologacao_observacoes" rows="3" class="mt-1 block w-full rounded border-gray-300 shadow-sm text-xs" placeholder="Observações sobre a homologação (opcional)"><?php echo e(old('homologacao_observacoes', $candidato->homologacao_observacoes)); ?></textarea>
