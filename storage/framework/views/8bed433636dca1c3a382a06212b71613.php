                    ...
                    <div x-show="tab === 'acoes'" x-transition x-cloak>
                        <div class="mt-8 pt-6 border-t p-4 bg-gray-100 rounded-lg">
                           <h3 class="text-lg font-semibold text-gray-800 mb-2">Painel de Ações do Administrador</h3>
                            ...
                            <?php if($candidato->recurso_status === 'em_analise' && $candidato->recurso_texto): ?>
                                <div class="mb-6 p-4 border-l-4 border-purple-500 bg-purple-50 text-purple-900 rounded-r-lg">
                                    ...
                                    <div class="mt-4 p-3 bg-white border border-gray-200 rounded-md text-sm space-y-3">
                                        <div>
                                            ...
                                            <p class="text-gray-800"><?php echo e($candidato->admin_observacao); ?></p>
                                        </div>
                                        <div class="border-t pt-3">
                                            <p class="font-semibold text-gray-600">Argumento do Recurso do Candidato:</p>
                                            <p class="text-gray-800 whitespace-pre-wrap"><?php echo e($candidato->recurso_texto); ?></p>
                                        </div>
                                    </div>

                                    <div class="mt-4 flex items-center space-x-4">
                                        <form action="<?php echo e(route('admin.recursos.deferir', $candidato)); ?>" method="POST" onsubmit="return confirm('Tem a certeza que deseja DEFERIR (aceitar) este recurso? A inscrição do candidato voltará para o status EM ANÁLISE.');">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <button @click="showResourceDenialModal = true; resourceDenialAction = '<?php echo e(route('admin.recursos.indeferir', $candidato)); ?>'" type="button" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg text-sm font-semibold hover:bg-red-700">
                                            Indeferir Recurso
                                        </button>
                                    </div>
                                </div>
