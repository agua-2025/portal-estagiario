...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" x-data="{ terms: false }">
        <?php echo csrf_field(); ?>
        ...
        <div class="block mt-4">
            <label for="terms" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600">
                    ...
                    <a target="_blank" href="<?php echo e(route('termos-de-uso')); ?>" class="underline hover:text-gray-900">Termos de Uso</a> 
                    e 
                    <a target="_blank" href="<?php echo e(route('politica-privacidade')); ?>" class="underline hover:text-gray-900">Política de Privacidade</a>.
                </span>
            </label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-4','xBind:disabled' => '!terms','xBind:class' => '{ \'opacity-50 cursor-not-allowed\': !terms }']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-4','x-bind:disabled' => '!terms','x-bind:class' => '{ \'opacity-50 cursor-not-allowed\': !terms }']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\portal-estagiario\resources\views/auth/register.blade.php ENDPATH**/ ?>