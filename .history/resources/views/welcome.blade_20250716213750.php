                ...
                <div class="relative z-10 max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <p class="mt-6 max-w-3xl mx-auto text-xl md:text-2xl text-gray-100 leading-relaxed">
                            Conectamos talentos promissores às melhores oportunidades de estágio na Prefeitura de Mirassol d'Oeste
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div data-aos="fade-left">
                            <div class="relative">
                                ...
                                <img src="https://images.pexels.com/photos/7129700/pexels-photo-7129700.jpeg" alt="Estudantes" class="relative w-full h-96 object-cover rounded-2xl shadow-2xl">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="classificacao" class="py-24 bg-white">
                ...
                <thead>
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="text-left py-4 px-6 text-sm font-semibold text-gray-900">Área de Atuação</th> <th class="text-left py-4 px-6 text-sm font-semibold text-gray-900">Instituição</th> <th class="text-left py-4 px-6 text-sm font-semibold text-gray-900">Pontuação</th>
                        <th class="text-left py-4 px-6 text-sm font-semibold text-gray-900">Status</th>
                    </tr>
                </thead>
                <tbody>
                    {{-- ✅ CÓDIGO DA TABELA DINÂMICA PARA A PÁGINA INICIAL --}}
                    @forelse($candidatosClassificacao as $index => $candidato)
                        <tr class="border-b border-gray-100 hover:bg-white transition-colors duration-200">
                            ...
                            <td class="py-4 px-6">
                                <div class="text-sm font-medium text-gray-900">{{ $candidato->nome_completo }}</div>
                                {{-- Remova a linha abaixo se o email não deve ser público na home --}}
                                <div class="text-sm text-gray-500">{{ $candidato->email }}</div>
                            </td>
                            <td class="py-4 px-6 text-sm text-gray-900">
                                {{ $candidato->curso->nome ?? 'Não Informado' }}
                            </td>
                             <td class="py-4 px-6 text-sm text-gray-900">
                                {{ $candidato->instituicao->nome ?? 'Não Informada' }}
                            </td>
                            <td class="py-4 px-6 text-sm text-gray-900">
                                {{ number_format($candidato->pontuacao_final, 1) }}
                            </td>
                            <td class="py-4 px-6">
                                @php
