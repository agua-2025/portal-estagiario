        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 space-y-8">
                    ...
                    {{-- ✅ INÍCIO DO AJUSTE CIRÚRGICO: O bloco de alertas foi substituído pela nova lógica --}}
                    {{-- A variável $temPendencias agora controla este alerta, vinda do DashboardController --}}
                    @if($temPendencias)
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-800">
                                        <span class="font-semibold">Atenção!</span> Sua inscrição possui pendências que precisam ser corrigidas.
                                        <br>
                                        Por favor, verifique as seções de <a href="{{ route('candidato.documentos.index') }}" class="font-bold underline">Meus Documentos</a> e <a href="{{ route('candidato.atividades.index') }}" class="font-bold underline">Minhas Atividades</a> para ver os detalhes e os prazos.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-purple-800">
                                        <span class="font-semibold">Parabéns!</span> Sua inscrição foi oficialmente **Homologada**!
