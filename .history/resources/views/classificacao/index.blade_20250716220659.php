            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    ...
                    <div class="flex items-center space-x-4" data-aos="fade-left">
                        ...
                        <a href="#" class="px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">Inscreva-se</a>
                    </div>
                </div>
            </div>
        </header>
                            ...
                            <table class="w-full results-table">
                                ...
                                <tbody>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">95,50</td>
                                    ...
                                    <tr x-show="open" x-transition.opacity.duration.300ms class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Nota da Prova</dt>
                                                    <dd class="font-medium text-gray-900">85,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">10,50</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Análise de Currículo</dt>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">89,25</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition.opacity.duration.300ms class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Nota da Prova</dt>
                                                    <dd class="font-medium text-gray-900">82,50</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">6,75</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Análise de Currículo</dt>
                                                    <dd class="font-medium text-gray-900">0,00</dd>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Pedro Henrique Lima</td>
                                        ...
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">78,30</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition.opacity.duration.300ms class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Nota da Prova</dt>
                                                    <dd class="font-medium text-gray-900">75,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">3,30</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Análise de Currículo</dt>
                                                    <dd class="font-medium text-gray-900">0,00</dd>
                            ...
                            <table class="w-full results-table">
                                ...
                                <tbody>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Ana Carolina Ferreira</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">321.***.***-**</td>
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">Aprovado</span>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">92,75</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition.opacity.duration.300ms class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Nota da Prova</dt>
                                                    <dd class="font-medium text-gray-900">88,50</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">4,25</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Análise de Currículo</dt>
                                                    <dd class="font-medium text-gray-900">0,00</dd>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Carlos Eduardo Souza</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">654.***.***-**</td>
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">Aprovado</span>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">86,40</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition.opacity.duration.300ms class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Nota da Prova</dt>
                                                    <dd class="font-medium text-gray-900">80,25</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">6,15</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Análise de Currículo</dt>
                                                    <dd class="font-medium text-gray-900">0,00</dd>
