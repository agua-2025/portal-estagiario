            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    ...
                    <div class="flex items-center space-x-4" data-aos="fade-left">
                        <a href="/login" class="text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors duration-200">Entrar</a>
                        <a href="/register" class="px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">Inscreva-se</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main>
            ...
            <section class="py-24 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <!-- Exemplo de curso com candidatos -->
                    <div class="course-section mb-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                        <div class="course-title bg-gray-50 p-6 border-b border-gray-200">
                            <h2 class="text-xl font-semibold text-gray-900">Engenharia de Software</h2>
                        </div>
                        ...
                        <div class="table-container overflow-x-auto">
                            <table class="w-full results-table">
                                ...
                                <tbody>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        <td class="py-4 px-6">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">João Silva Santos</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">123.***.***-**</td>
                                        ...
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">87,50</td>
                                    ...
                                    <tr x-show="open" x-transition x-cloak class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">25,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Formação Acadêmica</dt>
                                                    <dd class="font-medium text-gray-900">30,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Certificações</dt>
                                                    <dd class="font-medium text-gray-900">15,50</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Projetos Pessoais</dt>
                                                    <dd class="font-medium text-gray-900">10,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Entrevista</dt>
                                                    <dd class="font-medium text-gray-900">7,00</dd>
                                                </div>
                                            </dl>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                <div class="w-8 h-8 bg-slate-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                                    2
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Maria Oliveira Costa</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">456.***.***-**</td>
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">Aprovado</span>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">82,25</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition x-cloak class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">20,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Formação Acadêmica</dt>
                                                    <dd class="font-medium text-gray-900">30,00</dd>
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Certificações</dt>
                                                    <dd class="font-medium text-gray-900">18,25</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Projetos Pessoais</dt>
                                                    <dd class="font-medium text-gray-900">8,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Entrevista</dt>
                                                    <dd class="font-medium text-gray-900">6,00</dd>
                                                </div>
                                            </dl>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        <td class="py-4 px-6">
                                            <div class="flex items-center">
                                                <div class="w-8 h-8 bg-orange-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                                    3
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Carlos Eduardo Lima</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">789.***.***-**</td>
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">Rejeitado</span>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">75,80</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition x-cloak class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">18,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Formação Acadêmica</dt>
                                                    <dd class="font-medium text-gray-900">25,00</dd>
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Certificações</dt>
                                                    <dd class="font-medium text-gray-900">12,80</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Projetos Pessoais</dt>
                                                    <dd class="font-medium text-gray-900">15,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Entrevista</dt>
                    ...
                    <!-- Segundo curso de exemplo -->
                    <div class="course-section mb-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                        <div class="course-title bg-gray-50 p-6 border-b border-gray-200">
                            <h2 class="text-xl font-semibold text-gray-900">Administração</h2>
                        </div>
                            ...
                            <table class="w-full results-table">
                                ...
                                <tbody>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row" x-data="{ open: false }">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900">Ana Paula Ferreira</td>
                                        <td class="py-4 px-6 text-sm text-gray-500">321.***.***-**</td>
                                        <td class="py-4 px-6 text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">Aprovado</span>
                                        </td>
                                        <td class="py-4 px-6 text-sm font-bold text-blue-600 text-right">91,75</td>
                                        <td class="py-4 px-6 text-right">
                                            <button @click="open = !open" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                <span x-show="!open">Detalhes</span>
                                                <span x-show="open">Esconder</span>
                                    ...
                                    <tr x-show="open" x-transition x-cloak class="details-row">
                                        <td colspan="6" class="bg-gray-50 p-6">
                                            <dl class="details-list space-y-2">
                                                ...
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Experiência Profissional</dt>
                                                    <dd class="font-medium text-gray-900">35,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Formação Acadêmica</dt>
                                                    <dd class="font-medium text-gray-900">28,00</dd>
                                                </div>
                                                <div class="flex justify-between py-1 border-b border-gray-200">
                                                    <dt class="text-gray-600">Certificações</dt>
                                                    <dd class="font-medium text-gray-900">20,75</dd>
                                                </div>
                                                <div class="flex justify-between py-1">
                                                    <dt class="text-gray-600">Entrevista</dt>
                                                    <dd class="font-medium text-gray-900">8,00</dd>
