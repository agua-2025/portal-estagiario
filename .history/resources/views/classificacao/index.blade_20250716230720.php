{{-- Herda o layout principal do seu site. Se o seu for diferente, troque 'layouts.app'. --}}
@extends('layouts.app')

{{-- Define o título da página na aba do navegador --}}
@section('title', 'Classificação Geral de Candidatos')

{{-- Adiciona os estilos CSS específicos desta página no <head> do layout --}}
@push('styles')
<style>
    :root {
...
{{-- A mágica acontece aqui: todo este bloco será injetado no seu layout principal --}}
@section('content')
<div class="container">
