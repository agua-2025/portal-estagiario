    ...
    <div class="relative min-h-screen z-10">
        ...
        <main>
            ...
            <section class="py-24 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <!-- Back Button -->
                    <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl hover-scale" data-aos="fade-right">
                                    ...
                                    <table class="w-full results-table">
                                        ...
                                        <tbody x-data="{ open: {} }">
                                            @foreach($candidatos as $index => $candidato)
                                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 main-row">
                                                    <td class="py-4 px-6">
                                                    ...
                                                    <td class="py-4 px-6 text-right">
                                                        <button @click="open['{{ $candidato->id }}'] = !open['{{ $candidato->id }}']" class="text-blue-600 hover:text-blue-800 text-xs font-medium transition-colors duration-200">
                                                            <span x-show="!open['{{ $candidato->id }}']">Detalhes</span>
                                                            <span x-show="open['{{ $candidato->id }}']">Esconder</span>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <tr x-show="open['{{ $candidato->id }}']" x-transition class="details-row">
