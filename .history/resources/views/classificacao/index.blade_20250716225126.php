...
<head>
    ...
    <style>
        * {
        ...
        .gradient-bg { /* Cor de fundo principal se precisar, mas a main terá bg-gray-50 */
        ...
        /* Opcional: Blobs de fundo, se quiser a mesma vibe de fundo da home */
        .blob {
    ...
    {{-- ✅ IMPORTANTE: Se o Alpine.js for incluído via app.js com @vite, REMOVA a linha abaixo. --}}
    {{-- <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script> --}}

    {{-- Incluindo o app.css e app.js do Vite - O Alpine.js deve ser carregado via app.js --}}
...
<body class="antialiased bg-gray-50 overflow-x-hidden">
    ...
    <div class="relative min-h-screen z-10">
        ...
        <main class="py-24 bg-gray-50 flex flex-col items-center">
