...
<body class="antialiased bg-gray-50 overflow-x-hidden">
    ...
    <div class="relative min-h-screen z-10">
        ...
        <main class="gradient-bg py-16 text-white min-h-[calc(100vh-64px)] flex flex-col justify-center items-center">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center relative z-10" data-aos="fade-up" data-aos-duration="1000">
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-shadow mb-6">
                    <span class="block">Classificação Geral</span>
                    <span class="block text-yellow-300">dos Candidatos.</span>
                </h1>
