            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @php
                        ...
                        $initialData['instituicao_id'] = old('instituicao_id', $candidato->instituicao_id); // ✅ Passa o ID como número ou null
                        $initialData['curso_id'] = old('curso_id', $candidato->curso_id); // ✅ Passa o ID como número ou null
