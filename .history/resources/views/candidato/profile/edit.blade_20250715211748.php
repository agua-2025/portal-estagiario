                    ...
                    <script>
                        function profileFormComponent(initialFields, estados, todasCidades, instituicoes, todosCursos, totalProfileFields, completableFields) {
                            ...
                            $initialData['possui_deficiencia'] = old('possui_deficiencia', ($candidato->possui_deficiencia == 1) ? '1' : '0');
                                ...
                                $initialData['instituicao_id'] = old('instituicao_id', (string) ($candidato->instituicao_id ?? '')); // ✅ Garante que seja string e vazio se nulo
                                $initialData['curso_id'] = old('curso_id', (string) ($candidato->curso_id ?? '')); // ✅ Garante que seja string e vazio se nulo
