...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white p-8 rounded-lg shadow-md"> {{-- Aumentado padding e shadow para corresponder ao padrão --}}
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Editar Curso: {{ $curso->nome }}</h1> {{-- Título dentro do div do formulário --}}
        <form action="{{ route('admin.cursos.update', $curso) }}" method="POST">
            ...
            <div class="mb-6"> {{-- Aumentado margin-bottom para espaçamento --}}
                ...
                <input type="text" name="nome" id="nome" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('nome') border-red-500 @enderror" value="{{ old('nome', $curso->nome) }}" required>
                @error('nome')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p> {{-- Ajustado margin-top --}}
                @enderror
            </div>

            {{-- ✅ REMOVIDO: Campo Instituição --}}
            {{--
            <div class="mb-6">
                ...
                <select name="instituicao_id" id="instituicao_id" class="form-select w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('instituicao_id') border-red-500 @enderror" required>
                    ...
                    @foreach ($instituicoes as $instituicao)
                        <option value="{{ $instituicao->id }}" {{ old('instituicao_id', $curso->instituicao_id) == $instituicao->id ? 'selected' : '' }}>
                            {{ $instituicao->nome }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-6">
                ...
                <textarea name="descricao" id="descricao" rows="3" class="form-textarea w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('descricao') border-red-500 @enderror">{{ old('descricao', $curso->descricao) }}</textarea>
                @error('descricao')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="detalhes" id="detalhes" rows="6" class="form-textarea w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('detalhes') border-red-500 @enderror">{{ old('detalhes', $curso->detalhes) }}</textarea>
                @error('detalhes')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6"> {{-- Aumentado gap e margin-bottom --}}
                <div>
                    ...
                    <input type="number" step="0.01" name="valor_bolsa_auxilio" id="valor_bolsa_auxilio" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('valor_bolsa_auxilio') border-red-500 @enderror" value="{{ old('valor_bolsa_auxilio', $curso->valor_bolsa_auxilio) }}">
            ...
            <div class="mb-6">
                ...
                <textarea name="requisitos" id="requisitos" rows="4" class="form-textarea w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('requisitos') border-red-500 @enderror">{{ old('requisitos', $curso->requisitos) }}</textarea>
                @error('requisitos')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="beneficios" id="beneficios" rows="4" class="form-textarea w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('beneficios') border-red-500 @enderror">{{ old('beneficios', $curso->beneficios) }}</textarea>
                @error('beneficios')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8"> {{-- Aumentado gap e margin-bottom --}}
                <div>
                    ...
                    <input type="text" name="carga_horaria" id="carga_horaria" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('carga_horaria') border-red-500 @enderror" value="{{ old('carga_horaria', $curso->carga_horaria) }}">
                    @error('carga_horaria')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" name="local_estagio" id="local_estagio" class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out @error('local_estagio') border-red-500 @enderror" value="{{ old('local_estagio', $curso->local_estagio) }}">
                    @error('local_estagio')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
