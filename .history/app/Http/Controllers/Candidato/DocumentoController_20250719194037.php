...
use Carbon\Carbon; // ✅ Adicionado para timestamp no motivo da reversão
    ...
    public function destroy(Documento $documento)
    {
        ...
        try {
            ...
            if ($previousStatus === 'Homologado' && !$todosObrigatoriosAindaPresentes) {
                ...
                $revertHistory[] = [
                    'timestamp' => Carbon::now()->toDateTimeString(),
                    'reason' => "Documento obrigatório '{$documento->tipo_documento}' removido pelo candidato.", // ✅ Motivo detalhado
