...
class ProfileController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        // ✅ CORREÇÃO: Voltando a carregar TODAS as cidades.
        // Isso garante que o seu JavaScript original para o dropdown dinâmico volte a funcionar.
     ...
     * ✅ CORREÇÃO: Esta é a versão que salva os dados corretamente.
     */
    public function update(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            // O nome do campo no formulário deve ser 'estado' e o valor deve ser o ID
            'estado' => 'required|exists:estados,id', 
            // O nome do campo no formulário deve ser 'cidade' e o valor deve ser o ID
