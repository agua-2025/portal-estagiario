...
use App\Models\Candidato; // ✅ Adicionado: Importar o modelo Candidato
use App\Models\User;     // ✅ Adicionado: Importar o modelo User para acessar o candidato
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($previousStatus === 'Homologado') {
                ...
                $candidato->save();
                Log::info("Candidato ID {$candidato->id} (Homologado) adicionou atividade e voltou para 'Em Análise'.");
                return redirect()->route('candidato.atividades.index')->with('success', 'Atividade adicionada com sucesso! Sua inscrição (anteriormente homologada) voltou para "Em Análise" devido à alteração.');
            }
    ...
    public function update(Request $request, CandidatoAtividade $atividade)
    {
        ...
        try {
            ...
            if ($previousStatus === 'Homologado') {
                ...
                $candidato->homologacao_observacoes = null;
                $candidato->save();
                Log::info("Candidato ID {$candidato->id} (Homologado) atualizou atividade e voltou para 'Em Análise'.");
                return redirect()->route('candidato.atividades.index')->with('success', 'Atividade atualizada com sucesso! Sua inscrição (anteriormente homologada) voltou para "Em Análise" devido à alteração.');
            }
