...
class DocumentoController extends Controller
{
    ...
    public function index()
    {
        ...
        // ✅ PASSO 1: VERIFICAÇÃO PROFISSIONAL DO PERFIL
        // Verificamos se o candidato existe e se um campo essencial (como nome_completo) está preenchido.
        // Isso nos dá uma flag (true/false) para enviar para a view.
        $isProfileComplete = $candidato && !empty($candidato->nome_completo);

        // Preparamos as variáveis de documentos, mas só as preenchemos se o perfil estiver completo.
        ...
        // Finalmente, renderizamos a view e passamos todas as variáveis,
        // incluindo a nossa nova flag '$isProfileComplete'.
