...
class CandidatoController extends Controller
{
    ...
    public function update(Request $request, Candidato $candidato)
    {
        ...
        $candidato->status = $validatedData['status'];
        $candidato->admin_observacao = $validatedData['admin_observacao'];
        
        // ✅ LÓGICA ADICIONADA: Se o status for 'Aprovado', significa que a análise foi concluída.
        // Portanto, limpamos o histórico de reversões para que os alertas desapareçam.
