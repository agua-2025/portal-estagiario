...
class CandidatoController extends Controller
{
    ...
    /**
     * ✅ MÉTODO ATUALIZADO: Agora gerencia o status individual de cada documento.
     */
    public function updateDocumentStatus(Request $request, Documento $documento)
    {
        ...
        try {
            ...
            if ($documento->status === 'rejeitado') {
                ...
                // "Congela" o processo para o admin, como solicitado
                $candidato = $documento->user->candidato;
                if ($candidato) {
                    $candidato->status = 'Inscrição Incompleta';
                    $candidato->admin_observacao = "O documento '{$documento->tipo_documento}' foi rejeitado. Por favor, verifique a seção 'Meus Documentos' para mais detalhes.";
                    $candidato->save();
                }
