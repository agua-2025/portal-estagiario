...
class CandidatoController extends Controller
{
    ...
    public function show(Candidato $candidato)
    {
        ...
        // ✅ INÍCIO DA CORREÇÃO: Adiciona a lógica para carregar as variáveis necessárias para a view.
        // Lógica para determinar os documentos obrigatórios para este candidato
        ...
        // Pega os documentos que o candidato já enviou e os organiza por tipo
        $documentosEnviados = $candidato->user->documentos->keyBy('tipo_documento');
        // ✅ FIM DA CORREÇÃO

        $pontuacaoDetalhada = $candidato->calcularPontuacaoDetalhada();

        // ✅ ATUALIZADO: Passa as novas variáveis para a view.
    ...
    {
        $request->validate([
            'status' => 'required|in:Em Análise,Aprovado,Rejeitado,Homologado',
        ...
        try {
            $candidato->save();
            return redirect()->route('admin.candidatos.index')->with('success', 'Status do candidato atualizado com sucesso!');
        } catch (\Exception $e) {
