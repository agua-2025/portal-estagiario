...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (isset($validatedData['roles'])) {
                ...
                // Atribui o papel 'estagiario' por padrão se nenhum papel for selecionado
    ...
    {
        // Impede que o usuário logado apague a própria conta
        ...
        DB::beginTransaction();
        try {
            // Se o usuário tiver um perfil de candidato associado, apaga-o primeiro
            if ($user->candidato) {
                $user->candidato->delete();
            }

            $user->delete(); // Apaga o registro do usuário
    ...
    {
        // Verifica se o email já foi verificado para evitar reenvio desnecessário
