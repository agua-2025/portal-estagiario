        ...
        try {
            ...
            if ($documento->status === 'rejeitado') {
                ...
                if ($candidato) {
                    ...
                    // ✅ AJUSTE CIRÚRGICO E DEBUG:
                    $mensagemGenerica = "Um ou mais documentos obrigatórios foram rejeitados. Por favor, verifique os detalhes na seção 'Meus Documentos' e faça as correções necessárias.";
