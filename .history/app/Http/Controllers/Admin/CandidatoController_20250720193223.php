...
class CandidatoController extends Controller
{
    ...
    public function update(Request $request, Candidato $candidato)
    {
        ...
        if ($novoStatus === 'Rejeitado') {
            $candidato->status = 'Rejeitado'; // Define o status final
            $candidato->admin_observacao = $validatedData['admin_observacao'];
            $candidato->recurso_prazo_ate = $this->calcularDiasUteis(2); // Define o prazo
            $candidato->recurso_status = 'pendente';
            $candidato->recurso_tipo = 'rejeicao'; // Define o tipo de recurso
    ...
    /**
     * ✅ ADICIONADO: Método auxiliar para calcular dias úteis.
     */
