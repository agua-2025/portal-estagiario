        ...
        @else
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <div x-data="{ openCand: false }" class="border-t border-gray-200 pt-2">
                    <button @click="openCand = !openCand" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-gray-600">
                        <span>Candidatos</span>
                ...
                <div x-data="{ openCfg: false }" class="border-t border-gray-200 pt-2">
                    <button @click="openCfg = !openCfg" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-gray-600">
                        <span>Configurações</span>
