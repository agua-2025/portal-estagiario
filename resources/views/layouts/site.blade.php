        ...
        <header class="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between py-3 sm:py-4">
                    <!-- Logo e Título -->
                    <div class="flex items-center space-x-2" data-aos="fade-right"> <a href="{{ route('welcome') }}" class="flex items-center space-x-2">
            ...
            <div x-show="mobileMenuOpen" 
                ...
                <div class="px-4 py-3 space-y-3">
                    ...
                    <a href="{{ route('welcome') }}#perguntas-frequentes" class="block text-base font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200" @click="mobileMenuOpen = false">Perguntas Frequentes (FAQ)</a>
...
{{-- ... seu código HTML antes do widget ... --}}
