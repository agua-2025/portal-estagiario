                                        ...
                                        <div class="flex justify-between items-start">
                                            ...
                                            <div class="flex items-center gap-1 ml-3 flex-shrink-0">
                                                ...
                                                @if ($atividade->status !== 'Rejeitada')
                                                    <button @click="showRejectionModal = true; rejectionAction = '{{ route('admin.atividades.rejeitar', $atividade->id) }}'" type="button" class="py-1 bg-red-600 text-white rounded text-xs hover:bg-red-700 w-[70px] text-center">Rejeitar</button>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                       ...
                                       @foreach($candidato->recurso_historico as $index => $recurso)
                                           <div class="p-4 border rounded 
                                               ...
                                               <div class="mt-2">
                                                   ...
                                                   <div class="mt-1 text-xs text-gray-800 bg-white p-2 rounded border whitespace-pre-wrap">{{ $recurso['argumento_candidato'] }}</div>
                                               </div>

                                               @if(!empty($recurso['decisao_admin']))
                                                   <div class="mt-2">
                                                       <p class="text-xs font-medium text-gray-700">Justificativa:</p>
                                                       <div class="mt-1 text-xs text-gray-800 bg-white p-2 rounded border whitespace-pre-wrap">{{ $recurso['justificativa_admin'] ?? 'Não fornecida.' }}</div>
                                                   </div>
                                               @else
                                   ...
                                   @else
                                           ...
                                           <form action="{{ route('admin.candidatos.homologar', $candidato->id) }}" method="POST" class="w-full">
                                               ...
                                               <div class="bg-yellow-50 p-3 rounded">
                                                   ...
                                                   <div class="mb-2">
                                                       ...
                                                       <input type="text" name="ato_homologacao" id="ato_homologacao" required class="mt-1 block w-full rounded border-gray-300 shadow-sm text-xs" value="{{ old('ato_homologacao', $candidato->ato_homologacao) }}">
                                                   ...
                                                   <div class="mb-2">
                                                       ...
                                                       <textarea name="homologacao_observacoes" id="homologacao_observacoes" rows="2" class="mt-1 block w-full rounded border-gray-300 shadow-sm text-xs">{{ old('homologacao_observacoes', $candidato->homologacao_observacoes) }}</textarea>
                                       ...
                                       @elseif ($candidato->status === 'Homologado')
                                           <div class="bg-blue-50 p-3 rounded">
                                               ...
                                               <p class="text-xs text-blue-700">Ato: {{ $candidato->ato_homologacao ?? 'N/A' }}</p>
