        ...
        <form action="{{ route('admin.cursos.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="detalhes" 
                          ...
                          placeholder="Descrição detalhada do curso, objetivos, metodologia, etc.">{{ old('detalhes') }}</textarea>
                @error('detalhes')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="requisitos" 
                          ...
                          placeholder="Escolaridade, idade, experiência, etc.">{{ old('requisitos') }}</textarea>
                @error('requisitos')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="beneficios" 
                          ...
                          placeholder="Certificado, material didático, alimentação, etc.">{{ old('beneficios') }}</textarea>
                @error('beneficios')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
