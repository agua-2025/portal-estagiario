            ...
            <div class="ml-3 flex-1">
                ...
                <div class="mt-2 text-sm">
                    @if($documentosRejeitados->count() > 0)
                        <a href="{{ route('candidato.documentos.index') }}" class="inline-flex items-center text-red-700 hover:text-red-800 font-bold underline">
                            Corrigir {{ $documentosRejeitados->count() }} documento(s)
                    ...
                    @if($atividadesRejeitadas->count() > 0)
                        <a href="{{ route('candidato.atividades.index') }}" class="mt-1 inline-flex items-center text-red-700 hover:text-red-800 font-bold underline">
                            Verificar {{ $atividadesRejeitadas->count() }} atividade(s)
                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                        </a>
                    @endif
                </div>
                                ...
                                <div class="ml-3">
                                    <p class="text-base text-yellow-800">
                                        ...
                                        <a href="{{ route('candidato.documentos.index') }}" class="inline-flex items-center font-semibold text-yellow-700 hover:text-yellow-600 underline decoration-2 underline-offset-2">
                                            Acesse "Enviar Documentos" para completar.
                        ...
                        <div class="p-4 bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg shadow-sm">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 flex-grow">
                                    ...
                                    {{-- ✅ CONDIÇÃO DE SEGURANÇA ADICIONADA AQUI --}}
                                    @if(Auth::user()->candidato?->pode_interpor_recurso && Auth::user()->candidato->homologado_em)
                                        <div class="mt-3 pt-3 border-t border-purple-200">
                                            <p class="text-sm text-purple-700">
                                                ...
                                                @endphp
                                                <strong class="text-purple-800">{{ $prazoFinal->format('d/m/Y \à\s H:i') }}</strong>.
                                            </p>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <a href="{{ route('candidato.documentos.index') }}" class="group block p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200 hover:from-green-100 hover:to-green-200 hover:border-green-300 transition-all duration-200 shadow-sm hover:shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-semibold text-green-900 text-lg">Enviar Documentos</h4>
